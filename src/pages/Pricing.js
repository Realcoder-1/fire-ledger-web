...
export default function Pricing() {
  ...
  const applyCode = () => {
    ...
    setCouponMsg(`Code "${code}" applied — discount reflected at checkout.`);
  };

  const removeCode = () => {
    setCoupon(''); setCouponInput(''); setCouponMsg(''); setCouponValid(false);
  };
      ...
      <div className="pricing-hero">
        ...
        <div className="p-plans-grid">
          ...
          <div className="p-plan-card">
            ...
            <p className="p-plan-note">Full access every session. Data clears when you close the tab. Perfect for running your numbers once and knowing your FIRE date.</p>
            <ul className="p-plan-features">
              ...
              <li><span className="p-check p-cross">✗</span> Data does not persist</li>
          ...
          <div className="p-plan-card">
            ...
            <p className="p-plan-note">Transactions, settings, and history saved permanently. Pick up exactly where you left off every session.</p>
            <ul className="p-plan-features">
          ...
          <div className="p-plan-card p-plan-featured">
            ...
            <div className="p-plan-storage p-storage-cloud">☁ Data saved to cloud</div>
            <p className="p-plan-note">Everything in Monthly, billed once a year. Best for tracking your FIRE journey long-term.</p>
            <ul className="p-plan-features">
