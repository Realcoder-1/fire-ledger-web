...
export default function SignIn() {
  const { signInWithGoogle, user, hasSubscription } = useAuth();
  ...
  return (
    <div className="signin-page">
      ...
      <div className="signin-card">
        <div className="signin-logo">FIRE<span>Ledger</span></div>
        <h1 className="signin-title">Welcome back.</h1>
        <p className="signin-sub">
          Sign in to access your dashboard and pick up exactly where you left off.
        </p>
